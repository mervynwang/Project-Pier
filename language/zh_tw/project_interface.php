<?php
  ...
  */
  ...
  // Array of langs
  return array(
    'upcoming milestones in next 30 days' => '近期的里程碑(在未來30天內)',
    'show all upcoming milestones' => '顯示所有將來的里程碑 (總共 %s 個)',
  
    'recent activities' => '最近的進行中',
    'search button caption' => '搜索',
    'search result description' => '顯示 <strong>%s 的 %s</strong> 對像匹配 <strong>"%s"</strong> 的',
    
    // Options and descriptions
    'important message desc' => '重要消息被列在了專案消息頁面的側欄「重要消息」中',
    'enable comments' => '啟用評論',
    'enable comments desc' => '能查看這個對象的使用者能夠對它發表評論。選擇 "否" 來鎖定評論',
    'enable anonymous comments' => '匿名評論',
    'enable anonymous comments desc' => '允許匿名的評論被發表在這個專案上。匿名評論可以通過API或者其他資訊資訊源來發佈 (如果啟用了). 作者必須提供一個有效的姓名和電子郵件地址。 來源的 IP 地址將被記錄下來。',
    ...
    'comment posted on' => '發佈於 %s',
    'comment posted on by' => '發佈於 %s 通過 <a href="%s">%s</a>',
    ...
    'edit company data' => '<a href="%s">編輯</a> 公司資料',
    ...
    'project permissions form hint' => '使用 <a href="%s">權限表單</a> 你能方便地增加或者刪除公司和使用者，並控制他們的訪問權限.',
    
    'additional message text desc' => '只在評論頁面上可見的附加消息文字',
    ...
    'email notification desc' => '通過郵件把這個消息通知給選中的人',
    ...
    'subscribers desc' => '訂閱將在當其他人發佈一個評論在這個資訊上的時候收到一個郵件通知',
    'admins can post comments on locked objects desc' => '<strong>評論已被鎖定</strong>，但是你作為管理員將會有權限發佈評論。注意如果你期望從你的客戶或者非管理員使用者收到回復，你需要對這個對象的評論解鎖  <i>(上傳 "啟用評論" 選項為 "是")</i>.',
    ...
    'admin notice comments disabled' => '評論在這個對象上被停用, 但是你作為管理員將會有權限發佈評論。 如果你期望來自其他非管理員的回復，你需要上傳 "啟用評論" 為 "是"。',
    
    // iCal
    'icalendar' => 'iCalendar',
    'icalendar subscribe' => 'iCalendar',
    'icalendar subscribe desc' => '使用這個鏈接來導入所有里程碑和任務資料到你的常用的日曆應用中。',
    'icalendar password change notice' => '<strong>注意：</strong> 如果你改變了你的密碼，鏈接到日曆的資料也將改變！ 你需要重新訂閱。',
    
    // Private
    'private message desc' => '私有消息只對公司內部成員是可見的。 客戶公司成員將不能看到它們。',
